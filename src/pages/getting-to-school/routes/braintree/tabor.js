...
const NotleyHigh = () => (
	...
	<Layout>
		...
		<h1>Tabor Academy</h1>
		<img src={map} alt="A map showing cycle and walking routes to and from Tabor Academy" title="A map showing cycle and walking routes to and from Tabor Academy" />
