...
const ColchesterSixthForm = () => (
	<Layout>
		...
		<Breadcrumbs
			...
			two="Colchester Sixth Form College" />

		<h1>Colchester Sixth Form College</h1>
		<img src={map} alt="A map showing cycle and walking routes to and from Colchester Sixth Form College" title="A map showing cycle and walking routes to and from Colchester Sixth Form College" />
