...
const StJohnPayne = () => (
	...
	<Layout>
		...
		<img src={map} alt="A map showing cycle and walking routes to and from St John Payne Catholic School" title="A map showing cycle and walking routes to and from St John Payne Catholic School" />
