...
const Hylands = () => (
	...
	<Layout>
		...
		<img src={map} alt="A map showing cycle and walking routes to and from Great Baddow High School" title="A map showing cycle and walking routes to and from Great Baddow High School" />
