...
const Transport = () => (
	...
	<ul>
		<li><a href="https://www.gov.uk/government/publications/how-to-wear-and-make-a-cloth-face-covering">face coverings</a>: We are asking all children who can to wear a face covering. Wearing a face covering helps keep everyone safe. It takes a bit of getting used to, but it’s a simple measure most children can take. Please make sure your child has a face covering and knows how to use it. Some children are <a href="https://www.gov.uk/guidance/coronavirus-covid-19-safer-travel-guidance-for-passengers#exemptions-face-coverings">exempt from wearing face coverings</a></li>
		<li>a face covering doesn’t have to be a single use mask. It can be a scarf or a snood. <a href="https://www.gov.uk/government/publications/face-coverings-when-to-wear-one-and-how-to-make-your-own/face-coverings-when-to-wear-one-and-how-to-make-your-own#making-your-own-face-covering">Why not try making your own?</a></li>
		<li>changes to how children get on the bus and where they can sit – social distancing is not required on dedicated school services so children might be asked to sit with their year group for example</li>
	...
	<p>You’ll get a letter by the second week of August that will have more information and the contact details of the operator running your service. Alternatively, you can <a href="/getting-to-school/education-transport-operators">contact your transport operator</a>.</p>
