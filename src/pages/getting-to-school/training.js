...
const Training = () => {
  return (
      ...
      <p>Stop.Swap.<i>GO!</i> has teamed up with the <a href="https://saferessexroads.org/">Safer Essex Roads Partnership</a> to offer children and young people going into Years 7 through to 13 cycling and walking training.</p>
