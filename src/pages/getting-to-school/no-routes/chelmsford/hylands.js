...
const Hylands = () => (
	...
	<Layout>
		...
		<img src={map} alt="A map showing cycle and walking routes to and from Hylands School" title="A map showing cycle and walking routes to and from Hylands School" />
