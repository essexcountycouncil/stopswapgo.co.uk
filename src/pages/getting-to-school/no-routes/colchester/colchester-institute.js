...
const ColchesterInstitute = () => (
	<Layout>
		...
		<img src={map} alt="A map showing cycle and walking routes to and from Getting to and from Colchester Institute" title="A map showing cycle and walking routes to and from Getting to and from Colchester Institute" />
