...
class SixtyDayChallenge extends React.Component {
  render() {
    const page = this.props.data.contentfulSixtyDayChallengePage
    const options = {
      renderNode: {
...
export const sixtyDayChallengePageQuery = graphql`
  query sixtyDayChallengePageQuery( $id : String! ) {
    contentfulSixtyDayChallengePage( id: { eq: $id } ) {
      id
      title
      content {
        json
